...
#include "src/explicit_mpc_bst.cpp"
#include <vector>
#include <math.h>  
...
*/
   ...
   // std::cout << this->iris_state_vel[3] <<" "<< this->iris_state_vel[4] << "\n";
	...
	private: const char *filename_bst = "/home/schulze/iris_plugin_explicit_mpc/control_files/output_bst_20_2_u3_vt1.txt";

	private: std::vector<struct_regions> regions;

	private: const char *filename_regions = "/home/schulze/iris_plugin_explicit_mpc/control_files/output_regions_20_2_u3_vt1.txt";

	private: std::vector<struct_ineq_set> ineq_set;

	private: const char *filename_ineq_set = "/home/schulze/iris_plugin_explicit_mpc/control_files/output_ineq_20_2_u3_vt1.txt";
		
	private: struct_control_param control_param;

	private: const char *filename_control_param = "/home/schulze/iris_plugin_explicit_mpc/control_files/output_control_param_20_2_u3_vt1.txt";
